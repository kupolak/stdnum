let test_compact () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.compact input in
...
let test_from_base32 () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.from_base32 input in
...
let test_to_base32 () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.to_base32 input in
...
let test_calc_check_digit () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.calc_check_digit input in
      Alcotest.(check string)
...
let test_validate_base10 () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.validate_base10 input in
      Alcotest.(check string)
...
let test_validate_base32 () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.validate_base32 input in
      Alcotest.(check string)
...
let test_validate () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.validate input in
...
let test_is_valid () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = It.Aic.is_valid input in
...
let () = Alcotest.run "It.Aic" [ ("suite", suite) ]
