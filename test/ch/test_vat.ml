let test_compact () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch.Vat.compact input in
...
let test_validate () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch.Vat.validate input in
...
let test_is_valid () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch.Vat.is_valid input in
...
let test_format () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch.Vat.format input in
...
let () = Alcotest.run "Ch.Vat" [ ("suite", suite) ]
