let test_compact () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Uid.compact input in
...
let test_calc_check_digit () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Uid.calc_check_digit input in
...
let test_validate () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Uid.validate input in
...
let test_is_valid () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Uid.is_valid input in
...
let test_format () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Uid.format input in
...
let () = Alcotest.run "Ch_stdnum.Uid" [ ("suite", suite) ]
