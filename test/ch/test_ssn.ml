let test_compact () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Ssn.compact input in
...
let test_validate () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Ssn.validate input in
...
let test_is_valid () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Ssn.is_valid input in
...
let test_format () =
  ...
  List.iter
    (fun (input, expected_result) ->
      let result = Ch_stdnum.Ssn.format input in
...
let () = Alcotest.run "Ch_stdnum.Ssn" [ ("suite", suite) ]
